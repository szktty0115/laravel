        ...
        <div class="col-md-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('tournament.create', ['id' => $id]) }}" enctype="multipart/form-data" class="mt-3">
                        @csrf
                        <div class="form-group row">
                            <label for="game_name" class="col-md-4 col-form-label text-md-right"><span class="text-danger">※</span>ゲーム名</label>
                            <div class="col-md-6">
                                <input id="game_name" type="text" class="form-control @error('game_name') is-invalid @enderror" name="game_name" value="{{ old('game_name') }}" required autocomplete="name" autofocus>
                                @error('name')
